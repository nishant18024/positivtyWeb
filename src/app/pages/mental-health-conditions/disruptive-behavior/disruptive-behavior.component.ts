...
@Component({
  selector: 'app-disruptive-behavior',
  imports: [CommonModule, NgFor],
  templateUrl: './disruptive-behavior.component.html',
  styleUrl: './disruptive-behavior.component.scss'
})
export class DisruptiveBehaviorComponent {
