...
@Component({
  selector: 'app-adjustment-disorders',
  imports: [CommonModule, NgFor],
  templateUrl: './adjustment-disorders.component.html',
  styleUrl: './adjustment-disorders.component.scss'
})
export class AdjustmentDisordersComponent {
 therapies = [
    {
      icon: '🧠',
